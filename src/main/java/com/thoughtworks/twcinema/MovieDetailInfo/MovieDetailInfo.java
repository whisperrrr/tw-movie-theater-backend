...
import com.thoughtworks.twcinema.MovieClass.Casts;
import com.thoughtworks.twcinema.MovieClass.Directors;
import com.thoughtworks.twcinema.MovieClass.Images;
...
public class MovieDetailInfo {
    ...
    private List<Bloopers> bloopers;
    ...
    public List<Bloopers> getBloopers() {
        return bloopers;
    }

    public void setBloopers(List<Bloopers> bloopers) {
    ...
    public void setPopular_comments(List<PopularComments> popularComments) {
